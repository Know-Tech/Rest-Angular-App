...
<table>
	...
	<tr>
		<td colspan="2">
				...
				<input type="submit"
					value="<spring:message text="EmployeeRegister"/>" />
...
<c:if test="${!empty list}">
	...
	<c:forEach items="${list}" var="lists">
		<tr>
			...
			<td><a href="<c:url value='/edit/${lists.employeeid}'/>" >Edit</a></td>
			<td><a href="<c:url value='/remove/${lists.employeeid}' />" >Delete</a></td>
